...
//	}
	...
	public KMAC0(Config config, String outPrefix){
...
//	   	System.out.println(CommonUtils.arrayToString(profile, "%.4f"));
	...
	public KMAC0(Genome g, boolean useCache, boolean use_db_genome, String genomePath, Config config, String outPrefix){
		setConfig(config, outPrefix);
		genome = g;
	 ...
	 */
	public KMAC0(ArrayList<Kmer> kmers, Config config, String outPrefix){
	 ...
	 */
	public KMAC0(KmerSet kmerset, Config config, String outPrefix){
		setConfig(config, outPrefix);
...
//	    kmf.plotMotifDistanceDistribution(x, same, diff, args[0]+".png");
	...
	public static void main(String[] args){
        ...
        KMAC0 kmf = new KMAC0(config, name);
