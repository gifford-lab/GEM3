...
//		}
	 ...
	 *  The seqList should be aligned so that a new PWM can be built. <br>
...
//	}
	...
	private class NewKSM{
		ArrayList<Kmer> kmers=null;
		MotifThreshold threshold = null;	
		void setThreshold(){
			updateEngine(kmers);	
